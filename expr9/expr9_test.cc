...
// MF are identical
//The importance of this test is that it validates proper tensor product ordering of RT polynomials and lexicographic
// numbering and so on
// This test is now complete
//This works for dim=2, k=1,2
//There are issues with first compnent TP ordering for k>=3 onwards..TBD
/////////////////
