  ...
  try
    {
	  ...
	  deallog.push("2d");
      TestMixedLaplace<2, 1> test1; test1.run(); //ok
      TestMixedLaplace<2, 2> test2; test2.run(); //ok
      TestMixedLaplace<2, 3> test3; test3.run(); //ok
      TestMixedLaplace<2, 4> test4; test4.run(); //ok
      TestMixedLaplace<2, 5> test5; test5.run(); //ok
      deallog.pop();
    }
